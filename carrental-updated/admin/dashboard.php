...
<head>
	...
	<title>PakDrive365 - Car Rental | Admin Dashboard</title>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-danger text-light">
												<div class="stat-panel text-center">
<?php 
$sql3b ="SELECT id from tblcategories ";
$query3b= $dbh -> prepare($sql3b);
$query3b->execute();
$results3b=$query3b->fetchAll(PDO::FETCH_OBJ);
$categoriescnt=$query3b->rowCount();
?>												
													<div class="stat-panel-number h1 "><?php echo htmlentities($categoriescnt);?></div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												<div class="stat-panel text-center">
<?php 
$sql7 ="SELECT id from tblcities ";
$query7= $dbh -> prepare($sql7);
$query7->execute();
$results7=$query7->fetchAll(PDO::FETCH_OBJ);
$citiescnt=$query7->rowCount();
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($citiescnt);?></div>
													<div class="stat-panel-title text-uppercase">Cities</div>
												</div>
											</div>
