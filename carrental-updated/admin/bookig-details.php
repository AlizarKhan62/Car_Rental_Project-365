...
<head>
	...
	<title>PakDrive365 - Car Rental | New Bookings   </title>
...
<div id="print">
								...
								<table border="1"  class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%"  >
									...
									<?php 
$bid=intval($_GET['bid']);
									$sql = "SELECT tblbooking.CustomerName,tblbooking.CustomerEmail,tblbooking.CustomerPhone,tblbooking.CustomerAge,tblbooking.LicenseType,tblbooking.PickupCity,tblbooking.DropoffCity,tblbrands.BrandName,tblvehicles.VehiclesTitle,tblbooking.FromDate,tblbooking.ToDate,tblbooking.message,tblbooking.VehicleId as vid,tblbooking.Status,tblbooking.PostingDate,tblbooking.id,tblbooking.BookingNumber,
DATEDIFF(tblbooking.ToDate,tblbooking.FromDate) as totalnodays,tblvehicles.PricePerDay
									  from tblbooking left join tblvehicles on tblvehicles.id=tblbooking.VehicleId left join tblbrands on tblvehicles.VehiclesBrand=tblbrands.id where tblbooking.id=:bid";
$query = $dbh -> prepare($sql);
...
{				?>	
	<h3 style="text-align:center; color:red">#<?php echo htmlentities($result->BookingNumber);?> Booking Details </h3>
		...
		<tr>
											<th colspan="4" style="text-align:center;color:blue">Customer Details</th>
										</tr>
										<tr>
											<th>Booking No.</th>
										...
										<tr>											
											<th>Email</th>
											<td><?php echo htmlentities($result->CustomerEmail);?></td>
											<th>Phone</th>
											<td><?php echo htmlentities($result->CustomerPhone);?></td>
										</tr>
											<tr>											
											<th>Age</th>
											<td><?php echo htmlentities($result->CustomerAge);?></td>
											<th>Driving License</th>
											<td><?php echo htmlentities($result->LicenseType);?></td>
										</tr>
											<tr>											
											<th>Pickup City</th>
											<td><?php echo htmlentities($result->PickupCity);?></td>
											<th>Drop-off City</th>
											<td><?php echo htmlentities($result->DropoffCity);?></td>
										</tr>
