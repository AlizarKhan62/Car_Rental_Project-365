...
$checksql = "SELECT id FROM tblpages WHERE type=:pagetype";
$checkquery = $dbh->prepare($checksql);
$checkquery->bindParam(':pagetype',$pagetype, PDO::PARAM_STR);
$checkquery->execute();
...
$query = $dbh->prepare($sql);
$query -> bindParam(':pagename',$pagetype, PDO::PARAM_STR);
$query -> bindParam(':pagetype',$pagetype, PDO::PARAM_STR);
$query-> bindParam(':pagedetails',$pagedetails, PDO::PARAM_STR);
$query -> execute();
}
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
                  ...
                  <option value="manage-pages.php?type=homehero">Homepage Hero Text</option>
