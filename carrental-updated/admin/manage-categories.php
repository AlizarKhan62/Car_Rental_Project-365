...
<head>
	...
	<title>PakDrive365 - Car Rental | Admin Manage Categories   </title>
...
<a href="manage-categories.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
